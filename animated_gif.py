...
# display gif generation parameters once the file has been uploaded
if uploaded_file is not None:
    ...
    # Extract a video frame as a display image
    ...
    if generate_gif:
        ...
        st.info('File size of the generated GIF: {} MB'.format(fsize))
        ...
        with open('export.gif', 'rb') as file:
            btn = st.download_button(
                ...
                data=file,
                file_name=f'{fname}_scaling-{selected_resolution_scaling}_fps',
                mime='image/gif',
            )
else:
